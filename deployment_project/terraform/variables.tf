...
variable "eks_aws_auth_users" {
  ...
  default     = [
    ...
    "krd7@cdc.gov",
    "ukt1@cdc.gov",
    "danipan@deloitte.com",
    "kyoconnell@deloitte.com",
    "anthony.gray@leidos.com",
    "zls4@cdc.gov",
    "jeffjones9@deloitte.com",
    "xuz1@cdc.gov",
    "krd7@cdc.gov"
]
...
variable "tower_server_url" {
  type        = string
  default     = "https://amd-tower-dev.cdc.gov:443"
  description = "The URL for the Tower server."
}

## Tower Contact Email
variable "tower_contact_email" {
  type        = string
  default     = "oamd-platform@cdc.gov"
  description = "The contact email for the Tower platform."
}

## Tower JWT Secret
variable "tower_jwt_secret" {
  type        = string
  default     = "hDv6eLzpa5HboWUVf6bGWwnx33F7N55n3Wf"
  description = "JWT secret key for Tower authentication."
}

## Tower Crypto Secret Key
variable "tower_crypto_secretkey" {
  type        = string
  default     = "ZFCYf5MtnFTVM3DNqdWRLH3sqGHEibqpoTz"
  description = "Crypto secret key for Tower encryption."
}

## Tower Trusted Emails
variable "tower_trusted_emails" {
  type        = list(string)
  default     = [
    "run3@cdc.gov",
    "bun3@cdc.gov",
  ...
  description = "List of trusted email addresses for Tower access."
}
